...
<body>
	...
	<div class="container  panel panel-warning">
		<h3 class="panel-heading">RADIO - 단일선택</h3>
		<p>단일선택</p>
		<br>
		<form action="jsp024_request2.jsp" id="form">
			...
			<fieldset>
				...
				<div class="form-group">
					<label>수신 여부</label> 
					<input type="radio" id="agree" name="surgery" value="동의"> 
					<label for="agree">동의</label> 
					<input type="radio" id="disagree" name="surgery" value="비동의"> 
		...
		<script type="text/javascript">
			...
			$("#form").on("submit", function() {
				...
				if ($(":radio[name='surgery']:checked").length == 0) {
					alert("빈칸입니다\n확인해주세요");
					return false;
				}
			});
