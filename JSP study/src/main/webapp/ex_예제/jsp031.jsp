...
<body>
	...
	<div class="container  panel panel-warning">
		...
		-------------------------------------------------------
		sesstion 		session 		브라우저가 종료되기 전 까지
		-------------------------------------------------------
	...
	<%
	pageContext.setAttribute("name", "A.page"); 		//현재페이지
	request.setAttribute("name", "B.request"); 			//요청
	session.setAttribute("name", "C.session"); 			//브라우저 닫힐때
	application.setAttribute("name", "D.application");  //application
	%>
	<table class="table table-striped">
	<caption>SCOPT</caption>
	<tbody>
