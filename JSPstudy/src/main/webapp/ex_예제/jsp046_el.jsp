		...
		<form action="jsp046_result2.jsp" method="get">
			<fieldset>
				...
				<div class="form-group">
					<label for="">검색</label> <input type="search" placeholder="검색어를 입력해주세요" name="search" id="search" class="form-control" />
				</div>
...
jsp046_result2.jsp 페이지로 넘어가서 el을 이용해 출력
		...
		<form action="jsp046_result.jsp" method="get">
			<fieldset>
				...
				<div class="form-group">
					<input type="submit" value="로그인" title="로그인" class="btn btn-success"> <a value="다시작성" title="다시작성" class=" btn btn-success">다시작성</a>
				</div>
...
아래와 같이 출력
	...
	2. 넘겨준 name 파라미터와 저장한 세션 출력
		...
		<form action="${pageContext.request.contextPath}/ELTest4Session" method="post" id="form">
			<fieldset>
				<legend>PLUS PROGRAM</legend>
				<div class="form-group">
