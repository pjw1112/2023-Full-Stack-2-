...
PreparedStatement pstmt = conn.prepareStatement("insert into mvcboard1 (btitle,bcontent,bname,bip) values (?,?,?,?)");
pstmt.setString(1, btitle); /*이걸로 복잡한 조건문 ' 없이 대입가능*/
pstmt.setString(2, bcontent.trim());
