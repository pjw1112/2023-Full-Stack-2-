...
async function run(sentence) {
	...
	const parts = [
		{ text: "input :  23년 12월 23일부터 28일까지 회사자체 연휴기간이라 모든 일정 중단" },
		{ text: "output :  { \"start_date\" : \"2023-12-23T00:00\",\"end_date\" : \"2023-12-28T23:50\", \"content\" : \"회사자체 연휴기간 모든 일정 중단\",\"type\" : \"insert\"}" },
		{ text: "input :  2023년 1월 5일부터 1월 10일까지 휴가 신청" },
		{ text: "output :  { \"start_date\" : \"2023-01-05T00:00\", \"end_date\" : \"2023-01-10T23:50\", \"content\" : \"휴가 신청\" , \"type\" : \"insert\" }" },
		...
		{ text: "input :  23년 12월 24일부터 2주 동안 매일 아침 8시에 운동" },
		{ text: "output :  { \"start_date\" : \"2023-12-24T08:00\", \"end_date\" : \"2024-01-06T23:50\", \"content\" : \"매일 아침 운동\", \"type\" : \"insert\" }" },
		{ text: "input :  23년 12월 25일 휴가" },
		{ text: "output :  { \"start_date\" : \"2023-12-25T00:00\", \"end_date\" : \"2023-12-25T23:50\", \"content\" : \"휴가\", \"type\" : \"insert\" }" },
		...
		{ text: "input :  2023년 12월 3일 전체 일정 삭제" },
		{ text: "output :  { \"start_date\" : \"2023-12-03T00:00\", \"end_date\" : \"2023-12-03T23:50\", \"content\" : \"전체 일정 삭제\", \"type\" : \"delete\", \"order\" :\"all\" }" },
		{ text: "input :  2023년 12월 17일 첫번째 일정 지워줘" },
		{ text: "output :  { \"start_date\" : \"2023-12-17T00:00\", \"end_date\" : \"2023-12-17T23:50\", \"content\" : \"첫번째 일정 지우기\", \"type\" : \"delete\", \"order\" : \"1\" }" },
		...
		{ text: "input :  2023년 3월 4일 두번째 일정 오마카세가기 로 변경하고 5일 오후 7시로 바꿔줘" },
		{ text: "output :  { \"start_date\" : \"2023-03-04T00:00\", \"end_date\" : \"2023-03-04T23:50\", \"update_date\" : \"2023-03-05T19:00\", \"content\" : \"오마카세 가기\", \"type\" : \"update\", \"order\" : \"2\" }" },
		{ text: "input :  2023년 12월 25일 일정 전부 26일로 옮겨줘" },
		{ text: "output :  { \"start_date\" : \"2023-12-25T00:00\", \"end_date\" : \"2023-12-25T23:50\", \"update_date\" : \"2023-12-26T00:00\", \"content\" : \"0\", \"type\" : \"update\", \"order\" : \"all\" }" },
		{ text: "input :  24년 12월3일 첫번째꺼 2일로" },
