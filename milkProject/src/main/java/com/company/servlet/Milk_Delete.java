...
/**
 * Servlet implementation class Milk_Delete
 */
@WebServlet("/Milk_Delete")
public class Milk_Delete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pstmt.executeUpdate()>0) { result="milk 테이블 삭제 성공";}
